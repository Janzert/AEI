...
Greg Clark and available as part of his [Arimaa client](https://bitbucket.org/Rabbits/arimaa-client).  Place the executable for the
bot and `adapt.py` in the AEI directory and configure the bot. For example if
you download bot_fairy from [arimaa.com](http://arimaa.com/arimaa/download/)
